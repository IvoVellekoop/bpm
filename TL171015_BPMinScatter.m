...
E = Field.plane(10000/8,[1024 1024],0.9,'um');
...
Edata = Eout_air.data;
Ein_point = Field(Edata(:,:,400),10000/(8*1024),0.9,'um');
...
Eins = abs(Edata(:,:,400));
Edata = Edata(:,:,400)./Eins;
Edata_conj=(1./Edata).*Eins; 
Ein_shaped = Field(Edata_conj,10000/(8*1024),0.9,'um');

...
for shift=-2:2    
    ...
    Efoci{shift+3} = v.bfp_to_fp(sumfield .* phase_gradient, true);
...
for shift=-2:2
    ...
    disp(i)
    Estepfoci{shift+3} = v.bfp_to_fp(sumfield, true);
